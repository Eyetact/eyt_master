...
class ViewServiceProvider extends ServiceProvider
{
    ...
    View::composer(['admin.*', 'admin.*'], function ($view) {
		...
		if(Schema::hasTable('prooooducts')){
    if (Schema::hasColumn('prooooducts', 'testcal')){
    View::composer(['admin.*', 'admin.*'], function ($view) {
            return $view->with(
                'look_prooooducts',
                \App\Models\Admin\Prooooduct::all()
            );
        });
}
}
		...
		if(Schema::hasTable('prooooducts')){
    if (Schema::hasColumn('prooooducts', 'price')){
    View::composer(['admin.*', 'admin.*'], function ($view) {
            return $view->with(
                'look_prooooducts',
                \App\Models\Admin\Prooooduct::all()
		...
		if(Schema::hasTable('caaats')){
    if (Schema::hasColumn('caaats', 'name')){
    View::composer(['admin.*', 'admin.*'], function ($view) {
            return $view->with(
                'look_caaats',
                \App\Models\Admin\Caaat::all()
            );
        });
}
}
    ...
    View::composer(['admin.*', 'admin.*'], function ($view) {
		...
		if(Schema::hasTable('caaats')){
    if (Schema::hasColumn('caaats', 'award')){
    View::composer(['admin.*', 'admin.*'], function ($view) {
            return $view->with(
                'look_caaats',
                \App\Models\Admin\Caaat::all()
